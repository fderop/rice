...
- **scripts/sync-codex-from-local.sh** — Copies the current Codex configuration, rules, global instructions, and custom skills into `codex/`
- **scripts/setup-codex.sh** — Installs the tracked Codex configuration, rules, global instructions, and custom skills
...
- **claude/skills/** — Personal Claude Code skills; installed to `~/.claude/skills/`
